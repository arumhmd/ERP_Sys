...
<div class="purchase-preview-main" id="boxes">
    <div class="purchase-header">
        <table class="vertical-align-top">
            ...
            <tr>
                <td >
                    <h3 style=" display: block; text-transform: uppercase; font-size: 30px; font-weight: bold; padding: 15px; background: {{ $color }};color:{{ $font_color }} ">{{__('PURCHASE')}}</h3>
                ...
                <td class="text-right">
                    <img class="purchase-logo"  src="{{$img}}"
                         alt="">
                    <p>
